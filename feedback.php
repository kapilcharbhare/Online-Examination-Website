...
<body>
      ...
      <div class="col-md-10">
      <a href="" style="color:#000000">charbharek@gmail.com</a><br /><br />
      ...
      <a href="online-examination_web" target="_blank">About us</a>
      </div>
      <div class="col-md-3 box">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
      		...
      		<div class="row">
      		<div class="col-md-4">
      		 <img src="image/p1.jpeg" width=100 height=100 alt="Kapil Charbhare" class="img-rounded">
      		 </div>
      		 <div class="col-md-5">
      		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Kapil Charbhare</a>
      		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9021087593</h4>
      		<h4 style="font-family:'typo' ">charbharek@gmail.com</h4>
      		<h4 style="font-family:'typo' ">JNEC , Aurangabd</h4></div></div>
      		</p>
            </div>
